...
export const fetchWithErrorHandling = async (url, options = {}) => {
  ...
  // DISABLED MOCK INTERCEPTORS - Let real API calls through
  // Mock data interceptors have been removed to allow actual backend communication
  ...
  // REMOVED: Admin mock test URL interceptor - now calls real backend
  if (false) {  // Disabled mock data interceptor
  ...
  try {
    ...
    // DISABLED: Admin mock test fallback - now uses real backend API
    const shouldFallback = false || // Disabled: url.includes('/api/admin/mock-tests/') ||
